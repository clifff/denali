class Admin::EntriesController < AdminController
  ...
  private
    ...
    def entry_params
      params.require(:entry).permit(:title, :body, :slug, :status, :tag_list, :post_to_twitter, :post_to_tumblr, :post_to_flickr, :post_to_facebook, :post_to_slack, :post_to_pinterest, :post_to_instagram, :tweet_text, :show_in_map, :invalidate_cloudfront, photos_attributes: [:source_url, :source_file, :id, :_destroy, :position, :caption, :crop])
    end
